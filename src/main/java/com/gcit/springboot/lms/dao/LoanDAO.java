...
public class LoanDAO {
	...
	public int updateLoan(Integer cardNo, Integer branchId, Integer bookId, Timestamp dueDate) {
		int i = jdbcTemplate.update("update tbl_book_loans set dueDate = ? where bookId = ? && branchId = ? && cardNo = ?",
